...
The ``eigencages'' are the set of orthogonal characteristic 3D cage cavity images that span this lower-dimensional subspace, ordered in a hierarchy of importance. A latent representation/encoding of each cage follows from expressing it as a combination of the eigencages. 
