...
The approximation of considering a cage molecule in isolation includes only the influence of the intrinsic porosity on adsorption. e.g., Fig.~\ref{fig:expt_sim_compare} shows this method yields a very good prediction of experimental Xe and Kr Henry coefficients in noria \cite{patil2016noria} (NC2), but underestimates the Henry coefficients in CC3 \cite{chen2014separation}.
