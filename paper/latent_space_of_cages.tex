...
\begin{figure}
\centering
	\includegraphics[width=0.9\columnwidth]{../all_cages/grid_of_cages_labeled.pdf} % from GIMP
...
\centering
	\subfloat[][B15]{\includegraphics[width=0.3\columnwidth]{../data/grids/B15_raw.png}}
	\subfloat[][B24]{\includegraphics[width=0.3\columnwidth]{../data/grids/B24_raw.png}}
	\qquad
	\subfloat[][C6]{\includegraphics[width=0.3\columnwidth]{../data/grids/C6_raw.png}}
	\subfloat[][CD2]{\includegraphics[width=0.3\columnwidth]{../data/grids/CD2_raw.png}}
	\qquad
	\subfloat[][HC1]{\includegraphics[width=0.3\columnwidth]{../data/grids/HC1_raw.png}}
	\subfloat[][WC1]{\includegraphics[width=0.3\columnwidth]{../data/grids/WC1_raw.png}}	
...
%As the singular value decomposition is not equipped to learn rotational and translation invariance of the 3D cage cavity images, we must first center and align the cages in a consistent manner. 
...
% made with image zoom 1.4. see saved VisIT session in data/grids. mesh width 4, see snapshot.vtk
	\centering
	\subfloat[][$\bar{\mathbf{c}}$]{\includegraphics[width=0.3\columnwidth]{../data/grids/average_cage.png}\label{fig:avg_cage}}
	\\
	\subfloat[][$\mathbf{v}_1$]{\includegraphics[width=0.275\columnwidth]{../data/grids/eigencage_1.png}}
	\subfloat[][$\mathbf{v}_2$]{\includegraphics[width=0.275\columnwidth]{../data/grids/eigencage_2.png}}
		\qquad
	\subfloat[][$\mathbf{v}_3$]{\includegraphics[width=0.275\columnwidth]{../data/grids/eigencage_3.png}}
	\subfloat[][$\mathbf{v}_4$]{\includegraphics[width=0.275\columnwidth]{../data/grids/eigencage_4.png}}
		\qquad
	\subfloat[][$\mathbf{v}_5$]{\includegraphics[width=0.275\columnwidth]{../data/grids/eigencage_5.png}}
	\subfloat[][$\mathbf{v}_6$]{\includegraphics[width=0.275\columnwidth]{../data/grids/eigencage_6.png}}
...
% made with image zoom 1.4. see saved VisIT session in data/grids. mesh width 4, see snapshot.vtk
\centering
	\subfloat[][B25, exact $\nu=74$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_raw.png} \label{fig:b25_exact}}
	\qquad
	\subfloat[][$\nu=1$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_1sv.png}}
	\subfloat[][$\nu=2$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_2sv.png}}
	\subfloat[][$\nu=3$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_3sv.png}}
	\qquad
	\subfloat[][$\nu=4$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_4sv.png}}
	\subfloat[][$\nu=5$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_5sv.png}}
	\subfloat[][$\nu=6$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_6sv.png}}
	\qquad
	\subfloat[][$\nu=7$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_7sv.png}}
	\subfloat[][$\nu=8$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_8sv.png}}
	\subfloat[][$\nu=9$]{\includegraphics[width=0.275\columnwidth]{../data/grids/B25_9sv.png}}
...
To more rigorously judge the utility of the latent space that we learned with SVD, we assess if the regions in latent cage space are correlated with cage properties.
First, we investigate if simulated equilibrium xenon/krypton selectivity is correlated with the location of a cage in latent space.
We compute the Henry coefficient of xenon and krypton in the cages ($T=298$ K), including only the effect of the intrinsic porosity by taking an isolated cage in an empty simulation box and subtracting the Henry coefficient of helium to mimic an excess adsorption experiment as in Patil et al. \cite{patil2016noria}. The points in Fig.~\ref{fig:latent_space_S_Xe_Kr} are colored according to the simulated Xe/Kr selectivity at infinite dilution. Clearly, neighboring cages in the latent space are more likely to exhibit similar Xe/Kr selectivities than cages further apart. Despite that atom type was not explicitly fed into SVD to learn the latent cage space, the information about the shape of the cavity encoded into the latent representation is predictive of the simulated Xe/Kr selectivity. 
Similarly, we investigate if the molecule and cavity diameter of the cages computed by \texttt{pywindow} \cite{miklitz2018pywindow} are correlated with the location of a cage in latent space. Fig.~\ref{fig:cage_space_colored_by_diams_2D} clearly shows that cages nearby in latent space tend to have similar molecule and cavity diameters. Note that MC6, the largest cage in the database, appears to be an outlier. In addition, Fig.~\ref{fig:cage_space_colored_by_nb_windows} shows that cages within clusters in latent space strongly tend to have the same number of windows in which gas molecules can enter the cavity.
Together, Figs.~\ref{fig:latent_space_S_Xe_Kr} and \ref{fig:cage_space_colored_by_diams_2D} show that our latent representation of porous cage molecules is useful in predicting properties that are correlated with the shape of the cavity (as is the case for Xe/Kr separations \cite{sikora2012thermodynamic,simon2015best}) and thus lends a meaningful notion of similarity between two cage molecules.

\begin{figure}
\centering
	\includegraphics[width=\columnwidth]{../cage_space_colored_by_S_Xe_Kr.png}
...
\begin{figure}
\centering
	\subfloat[][CC9]{\includegraphics[width=0.165\columnwidth]{../data/grids/DC1_CC9_c0.png}}
	\subfloat[][]{\includegraphics[width=0.165\columnwidth]{../data/grids/DC1_CC9_cpt2.png}}
	\subfloat[][]{\includegraphics[width=0.165\columnwidth]{../data/grids/DC1_CC9_cpt4.png}}
	\subfloat[][]{\includegraphics[width=0.165\columnwidth]{../data/grids/DC1_CC9_cpt6.png}}
	\subfloat[][]{\includegraphics[width=0.165\columnwidth]{../data/grids/DC1_CC9_cpt8.png}}
	\subfloat[][DC1]{\includegraphics[width=0.165\columnwidth]{../data/grids/DC1_CC9_c1.png}}
		\caption{Walking through latent space from cage CC9 (a) to DC1 (f). (b-e) are fictitious cage cavities generated by walking along a line between the latent representation of CC9 and DC1.
